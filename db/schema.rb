...
ActiveRecord::Schema.define(:version => 20160902033333) do
  ...
  create_table "refinery_wheels", :force => true do |t|
    ...
    t.datetime "updated_at",            :null => false
    t.string   "slug"
    t.float    "wheelset_price"
    t.float    "wheelset_weight"
    t.text     "wheelset_description"
    t.integer  "wheelset_id"
  end

  add_index "refinery_wheels", ["slug"], :name => "index_refinery_wheels_on_slug"

  create_table "refinery_wheelsets", :force => true do |t|
    t.string   "name"
  ...
  add_index "refinery_wheelsets", ["slug"], :name => "index_refinery_wheelsets_on_slug"
